// EZ Physicals Location Search - Fast Local Search
      ...
      html += `
        <div class="location-card">
          ...
          <div class="location-actions">
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(loc.address + ', ' + loc.city + ', ' + loc.state + ' ' + loc.zip)}" 
               target="_blank" 
               class="cta secondary small">Get Directions</a>
          </div>
        </div>
      `;
    });
